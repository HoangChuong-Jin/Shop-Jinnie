   ...
   <div class="row">
      <div class="col-sm-6">
         <div class="alert alert-primary" role="alert">
            Miễn phí vận chuyển cho đơn hàng có giá trị từ 149K
         </div>
      </div>
   </div>
   <h5>GIỎ HÀNG</h5> 
         ...
         <table class="table table-sm">
            ...
            foreach($giohang as $ma => $mp):
               ...
               <tr>
                  ...
                  <td class="text-center"><a href="index.php?action=xoamotmathang&id=<?php echo $ma; ?>"><i class="bi bi-trash-fill text-danger"></i></a></td>
               </tr>
            ...
            <tr>
               <td colspan="4">
               <a href="?action=xoagiohang">Xoá tất cả</a></td>
