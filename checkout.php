   ...
   <div class="row">
      <div class="col-sm-12">
         <div class="alert alert-success alert-dismissible fade show mb-0" role="alert">
            <i class="bi bi-check-circle-fill"></i> <?php echo $message; ?><a href="?action=dangnhap"> Đăng nhập ngay bây giờ!</a>
   ...
   <div class="row">
      <div class="col-sm-6">
         ...
         <form method="post">
            ...
            <div class="form-group">
               <label for="">Địa chỉ</label>
               <textarea type="text" name="diachi" class="form-control" required></textarea>
            </div>
            <div class="form-group">
               <label for="">Ghi chú (tuỳ chọn)</label>
               <textarea type="text" name="ghichu" class="form-control" placeholder="Lưu ý khi giao hàng" required></textarea>
            </div>
            <div>
               <button type="submit" class="btn btn-lg btn-danger btn-block">Hoàn tất đơn hàng</button>
            </div>
         ...
         <table class="table table-sm">
            ...
            foreach($giohang as $ma => $mp):
               ...
               <tr>
                  ...
                  <td ><h6 class="text-secondary" ><?php echo $mp["tensanpham"]; ?> <b>x <?php echo $mp["soluong"]; ?></b></h6></td>
